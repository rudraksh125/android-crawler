...
public class AfterEventDontExplore implements ExplorationCriteria {
	...
	public boolean checkDescription() {
		...
		Log.i("androidripper", "Checking for exploration: event description = " + eventDescription);
	...
	public boolean checkWidgetName() {
		...
		Log.i("androidripper", "Checking for exploration: event widget name = " + widgetDescription);
		for (String desc: this.forbiddenDescriptions) {
