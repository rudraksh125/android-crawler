...
public class WPCustomWidgetsComparator extends NameComparator {
	
	public final static boolean IGNORE_ACTIVITY_NAME = true;
	private boolean byName = true;
	protected String[] widgetClasses;
	
	public WPCustomWidgetsComparator (String... widgets) {
		super ();
		this.widgetClasses = widgets; 
	}
	
	public WPCustomWidgetsComparator (boolean ignore, String... widgets) {
		this(widgets);
		this.byName = !ignore;
	}
	...
	public boolean compare(ActivityState currentActivity, ActivityState storedActivity) {
		...
		for (WidgetState campo: currentActivity) {
			...
			boolean particullary =((currentActivity.getName().equals("Posts"))
								 &&(campo.getId().equals("2131165236"))
