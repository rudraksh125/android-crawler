...
public class DictionaryValueAutoEditor extends InteractorAdapter {
	...
	public DictionaryValueAutoEditor(Abstractor theAbstractor, String... simpleTypes) {
		super(theAbstractor, simpleTypes);
	}

	public DictionaryValueAutoEditor(String... simpleTypes) {
		super(simpleTypes);
	}
	...
	public String[] getValues(WidgetState w)
	{
		...
		{
			Log.i("androidripper", "DictionaryValueAutoEditor: Using values from cache");
		...
		{			
			Log.i("androidripper", "DictionaryValueAutoEditor: Saving values to cache");
			ValuesCache vCache = ValuesCache.getInstance(); 
